...
public class GsaGrammarParser extends Parser {
	...
	public final ProgContext prog() throws RecognitionException {
		...
		try {
			...
			do {
				...
				_errHandler.sync(this);
				_la = _input.LA(1);
			} while ( (((_la) & ~0x3f) == 0 && ((1L << _la) & ((1L << NUM) | (1L << INT_TYPE) | (1L << ID))) != 0) );
			setState(12);
			match(EOF);
			}
		}
	...
	public static class DeclarationContext extends DeclContext {
		public TerminalNode INT_TYPE() { return getToken(GsaGrammarParser.INT_TYPE, 0); }
		...
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof GsaGrammarListener ) ((GsaGrammarListener)listener).enterDeclaration(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof GsaGrammarListener ) ((GsaGrammarListener)listener).exitDeclaration(this);
		}
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof GsaGrammarVisitor ) return ((GsaGrammarVisitor<? extends T>)visitor).visitDeclaration(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public static final String _serializedATN =
		...
		"\f\r\3\2\2\2\r\16\3\2\2\2\16\17\7\2\2\3\17\3\3\2\2\2\20\21\7\7\2\2\21"+
		"\22\7\b\2\2\22\23\7\3\2\2\23\24\7\6\2\2\24\5\3\2\2\2\25\26\b\4\1\2\26"+
		"\31\7\b\2\2\27\31\7\6\2\2\30\25\3\2\2\2\30\27\3\2\2\2\31\"\3\2\2\2\32"+
